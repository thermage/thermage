...
test('test alert warning', function (): void {
    ...
    $alert = terminal()->getCsi() . "30m" . terminal()->getCsi() . "43m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "43m" . terminal()->getCsi() . "30m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "30m" . terminal()->getCsi() . "43m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "43m" . terminal()->getCsi() . "30mStayRAD!" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "30m" . terminal()->getCsi() . "43m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "43m" . terminal()->getCsi() . "30m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m";
    expect(str_replace([PHP_EOL, " "], "", strings($value)->trim()->toString()))->toEqual($alert);
});

test('test alert danger', function (): void {
    $value = alert('Stay RAD!')->danger()->renderToString();
    $alert = terminal()->getCsi() . "37m" . terminal()->getCsi() . "41m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "41m" . terminal()->getCsi() . "37m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "37m" . terminal()->getCsi() . "41m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "41m" . terminal()->getCsi() . "37mStayRAD!" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "37m" . terminal()->getCsi() . "41m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "41m" . terminal()->getCsi() . "37m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m";
    expect(str_replace([PHP_EOL, " "], "", strings($value)->trim()->toString()))->toEqual($alert);
});

test('test alert success', function (): void {
    $value = alert('Stay RAD!')->success()->renderToString();
    $alert = terminal()->getCsi() . "30m" . terminal()->getCsi() . "42m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "42m" . terminal()->getCsi() . "30m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "30m" . terminal()->getCsi() . "42m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "42m" . terminal()->getCsi() . "30mStayRAD!" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "30m" . terminal()->getCsi() . "42m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "42m" . terminal()->getCsi() . "30m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m";
    expect(str_replace([PHP_EOL, " "], "", strings($value)->trim()->toString()))->toEqual($alert);
});

test('test alert primary', function (): void {
    $value = alert('Stay RAD!')->primary()->renderToString();
    $alert = terminal()->getCsi() . "37m" . terminal()->getCsi() . "44m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "44m" . terminal()->getCsi() . "37m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "37m" . terminal()->getCsi() . "44m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "44m" . terminal()->getCsi() . "37mStayRAD!" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "37m" . terminal()->getCsi() . "44m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "44m" . terminal()->getCsi() . "37m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m";
    expect(str_replace([PHP_EOL, " "], "", strings($value)->trim()->toString()))->toEqual($alert);
});

test('test alert secondary', function (): void {
    $value = alert('Stay RAD!')->secondary()->renderToString();
    $alert = terminal()->getCsi() . "30m" . terminal()->getCsi() . "100m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "100m" . terminal()->getCsi() . "30m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "30m" . terminal()->getCsi() . "100m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "100m" . terminal()->getCsi() . "30mStayRAD!" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "30m" . terminal()->getCsi() . "100m" . terminal()->getCsi() . "0m" . terminal()->getCsi() . "100m" . terminal()->getCsi() . "30m" . terminal()->getCsi() . "39m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "49m" . terminal()->getCsi() . "39m";
    expect(str_replace([PHP_EOL, " "], "", strings($value)->trim()->toString()))->toEqual($alert);
});
